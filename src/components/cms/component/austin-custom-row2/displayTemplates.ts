...
import type DefaultAustinCustomRow2Styles from "./default-austin-custom-row2.opti-style.json";

export type AustinCustomRow2Component<DT extends Record<string, unknown> = Record<string, unknown>> = ComponentType<
	AustinCustomRow2ComponentProps<DT>
>;
export type AustinCustomRow2ComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> =
...
export type DefaultAustinCustomRow2Component<DT extends Record<string, unknown> = Record<string, unknown>> =
	ComponentType<DefaultAustinCustomRow2ComponentProps<DT>>;
export type DefaultAustinCustomRow2ComponentProps<DT extends Record<string, unknown> = Record<string, unknown>> =
